...
class AlarmUtil {
    ...
    void sendNotification(AlarmModel alarm) {
        try {
            ...
            if (playSound && am.getRingerMode() == AudioManager.RINGER_MODE_NORMAL) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                ...
                // play vibration
                if (alarm.isVibrate() && am.getRingerMode() != AudioManager.RINGER_MODE_SILENT) {
            ...
            if (alarm.isHasButton()) {
                ...
                PendingIntent pendingSnooze = PendingIntent.getBroadcast(mContext, notificationID, snoozeIntent, PendingIntent.FLAG_IMMUTABLE | PendingIntent.FLAG_UPDATE_CURRENT);
